(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('agendeiApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-agendeiApp-error');
                var entityKey = httpResponse.headers('X-agendeiApp-params');
                if (errorHeader) {
